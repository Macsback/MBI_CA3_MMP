...
class KonfettiViewModel : ViewModel() {
    ...
    /**
     * Starts a festive animation using a drawable shape.
     * @param drawable A DrawableShape used for particles.
     */
    fun festive(drawable: Shape.DrawableShape) {
        _state.value = State.Started(
            party = Presets.festive(drawable)
        )
    }
    ...
    fun explode() {
        _state.value = State.Started(
            party = Presets.explode()
        )
    }

    /**
     * Starts a parade animation.
     */
    fun parade() {
        _state.value = State.Started(
            party = Presets.parade()
        )
    }

    /**
     * Starts a rain animation.
     */
    fun rain() {
        _state.value = State.Started(
            party = Presets.rain()
    ...
    /**
     * Resets the state to idle when all animations are finished.
     */
    fun ended() {
    ...
    /**
     * State management for the KonfettiViewModel.
     */
    sealed class State {
